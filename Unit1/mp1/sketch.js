...
function setup() {
  ...
  noStroke();
  text("time log: ");
  text("9/13/22 2.5 hrs - designing base");
  text("9/13/22 2 hrs - finishing windows and making character");
  text("9/13/22 2 hrs - finishing character(when mouse is and isn't pressed)");
...
function draw() {
  ...
  //street
  fill(51, 51, 51);
  rect(565, 536, 1130, 50);
  noStroke();
  //buildings
  fill(184, 77, 141);
  rect(110, 300, 200, 425);
  fill(227, 214, 116);
  rect(345, 275, 170, 475);
  fill(134, 174, 219);
  rect(800, 255, 190, 515);
  fill(154, 129, 212);
  rect(1040, 300, 250, 425);
  ...
  rect(750, 350, 60, 200);
  //building4
  rect(1025, 150, 190, 75);
  rect(1025, 240, 190, 75);
  rect(1025, 330, 190, 75);
  rect(1025, 420, 190, 75);
